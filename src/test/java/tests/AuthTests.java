...
public class AuthTests extends BaseTest {
	...
	public void TC011_LoginFailedWrongUsername() {
		...
		login.loginFailed("WrongUsername", Config.PASSWORD,softAssert);
	...
	public void TC012_LoginFailedWrongPassword() {
		...
		login.loginFailed(Config.USERNAME, "WrongPassword",softAssert);
	...
	public void TC013_LoginFailedEmptyUsername() {
		...
		login.loginFailed("", Config.PASSWORD,softAssert);
	...
	public void TC014_LoginFailedEmptyPassword() {
		...
		login.loginFailed(Config.USERNAME, "",softAssert);
