...
public class AppointmentTests extends BaseTest {
	...
	public void TC_018VerifyAppointmentSummaryPage() {
		...
		appointmentSummary.verifyAppointmentSummaryPageElements(softAssert);
	...
	public void TC_019AppointmentFailedEmptyDate() {
		...
		AppointmentPage appointment = new AppointmentPage(driver);
		appointment.verifyAppointmentPageElements(softAssert);
		appointment.fillingFormAppointmentFailedEmptyDate(softAssert);
	...
	public void TC_020AppointmentFailedInvalidDate() {
		...
		AppointmentPage appointment = new AppointmentPage(driver);
		appointment.verifyAppointmentPageElements(softAssert);
		appointment.fillingFormAppointmentFailedInvalidDate(softAssert);
